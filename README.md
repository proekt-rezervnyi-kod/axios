...
**Оригинальный проект:** axios  
**Оригинальный автор:** [axios](https://github.com/axios)  
**Владелец форка:** [proekt-rezervnyi-kod](https://github.com/proekt-rezervnyi-kod)  
**Лицензия:** MIT  
**Источник (оригинал):** [GitHub — axios/axios](https://github.com/axios/axios)  
**Текущий репозиторий (форк):** [GitHub — proekt-rezervnyi-kod/axios](https://github.com/proekt-rezervnyi-kod/axios)  

### Перенос согласно соглашению проекта «Резервный код»

Данный репозиторий является форком оригинального проекта `axios`, созданным в рамках инициативы «Резервный код» для обеспечения доступности критически важных опенсорс‑проектов в условиях возможных ограничений доступа к международным платформам.

Перенос выполнен с соблюдением условий лицензии MIT. Все права на исходный код принадлежат оригинальному автору.
